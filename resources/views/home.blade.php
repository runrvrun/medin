				...
				<div class="tab-pane active" id="first-tab-alt">
					<div class="section-content row">
						<div class="col-sm-6 animated" data-delay="200" data-duration="700" data-animation="fadeInLeft">
							<img src="{{ asset('startuply') }}/img/features/people.jpg" class="img-responsive" alt="process 3" />
						</div>
				...
				<div class="tab-pane" id="second-tab-alt">
					<div class="section-content row">
						<div class="col-sm-6 pull-right animated" data-delay="200" data-duration="700" data-animation="fadeInRight">
							<img src="{{ asset('startuply') }}/img/features/phone.jpg" class="img-responsive pull-right" alt="process 2" />
						</div>
						<div class="col-sm-6 animated" data-delay="200" data-duration="700" data-animation="fadeInLeft">
							<br/><br/>
							<article class="align-center">
		...
		<div class="container">
			<div class="section-content row">
				<div class="col-sm-6 pull-right animated" data-duration="500" data-animation="fadeInRight">
					<img src="{{ asset('startuply') }}/img/features/content_image1.png" class="img-responsive" alt="process 2" />
				</div>
				...
				<div class="col-sm-6 animated" data-duration="500" data-animation="fadeInLeft">
					<img src="{{ asset('startuply') }}/img/features/helmet.jpg" class="img-responsive" alt="process 3" />
				</div>
			...
			<div class="section-content">
				<div class="featured-tab">
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="home"><img src="{{ asset('startuply') }}/img/features/rich_features_1.png" class="img-responsive animated" data-duration="900" data-animation="flip3dInTop" alt="macbook" /></div>
						<div class="tab-pane" id="profile"><img src="{{ asset('startuply') }}/img/features/rich_features_2.png" class="img-responsive animated" data-duration="900" data-animation="roll3dInLeft" alt="macbook" /></div>
						<div class="tab-pane" id="messages"><img src="{{ asset('startuply') }}/img/features/rich_features_3.png" class="img-responsive animated" data-duration="900" data-animation="fadeInRight" alt="macbook" /></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="flex-manual">
					<div class="col-xs-12 col-sm-4 wrap">
						<div class="switch flex-active">
							<img alt="client" src="{{ asset('startuply') }}/img/people/profile-1.jpg" class="sm-pic img-circle pull-left" width="69" height="70">
							<p>
					...
					<div class="col-xs-12 col-sm-4 wrap">
						<div class="switch pull-left">
							<img alt="client" src="{{ asset('startuply') }}/img/people/profile-2.jpg" class="sm-pic img-circle pull-left" width="69" height="70">
							<p>
					...
					<div class="col-xs-12 col-sm-4 wrap">
						<div class="switch">
							<img alt="client" src="{{ asset('startuply') }}/img/people/profile-1.jpg" class="sm-pic img-circle pull-left" width="68" height="69">
							<p>
