  ...
  var clndrTemplate =
    "<div class='clndr-controls'>" +
        "<div class='clndr-control-button'>" +
            "<span class='clndr-previous-button btn btn-outline-primary'>&laquo;</span>" +
        '</div>' +
        "<div class='month'><h4 class='card-title'><%= month %> <%= year %></h4></div>" +
        "<div class='clndr-control-button rightalign'>" +
            "<span class='clndr-next-button  btn btn-outline-primary'>&raquo;</span>" +
        '</div>' +
    '</div>' +
    ...
    '<div class="card">' +
        ...
        '<h3 class="mb-1 primary"><a href="<%= event.url %>"><%= event.title %></a></h3>' +
        '<span><i class="ft-map-pin"></i> <%= event.location %></span>' +
        '</div>' +
        '<div class="align-self-center event-item-shortdate">' +
        '<%= event.shortdate %>' +
        '</div>' +
        '</div>' +
        '</div>' +
