$(document).ready(function() {
  ...
  // filterer toggle & close button click events  [Remove filterer code from production]
  $(".filterer-toggle").on("click", function() {
    $(".filterer").toggleClass("open");
  });
  $(".filterer-close").on("click", function() {
    $(".filterer").removeClass("open");
  });
  if ($(".filterer-content").length > 0) {
    $(".filterer-content").perfectScrollbar({
      theme: "dark"
    });
  }
  ...
  $(".cz-bg-color span").on("click", function() {
    ...
    if (bgColor == "white") {
      $(".logo-img img").attr("src", "/images/medin.png");
    } else {
      if (
        $(".logo-img img").attr("src") == "/images/medin.png"
      ) {
        $(".logo-img img").attr("src", "/images/medin-white.png");
      }
    }
  });
  ...
  $(".filterer .cz-tl-bg-color .col .rounded-circle").on("click", function() {
    $("body").removeClass(
  ...
  $(".cz-tl-bg-image .col-sm-3 img.rounded").on("click", function() {
    ...
    $(this).addClass("selected");
    if (
      $(".filterer .cz-tl-bg-color .col .rounded-circle").hasClass("selected")
    ) {
      $(".filterer .cz-tl-bg-color .col .rounded-circle").removeClass(
        "selected"
      );
    }
  });
  ...
  $(".filterer-content .bg-hibiscus").on("click", function() {
    $("body").addClass("bg-hibiscus");
  });

  // Purple Pizzazz

  $(".filterer-content .bg-purple-pizzazz").on("click", function() {
    $("body").addClass("bg-purple-pizzazz");
  });

  // Blue Lagoon

  $(".filterer-content .bg-blue-lagoon").on("click", function() {
    $("body").addClass("bg-blue-lagoon");
  });

  // Electric Violet

  $(".filterer-content .bg-electric-violet").on("click", function() {
    $("body").addClass("bg-electric-violet");
  });

  // Portage

  $(".filterer-content .bg-portage").on("click", function() {
    $("body").addClass("bg-portage");
  });

  // Tundora

  $(".filterer-content .bg-tundora").on("click", function() {
    $("body").addClass("bg-tundora");
  });

  // Transparent BG IMG

  $(".filterer-content .bg-glass-1").on("click", function() {
    $("body").addClass("bg-glass-1");
  });

  $(".filterer-content .bg-glass-2").on("click", function() {
    $("body").addClass("bg-glass-2");
  });

  $(".filterer-content .bg-glass-3").on("click", function() {
    $("body").addClass("bg-glass-3");
  });

  $(".filterer-content .bg-glass-4").on("click", function() {
